...
#SBATCH --mem=25G
#SBATCH --job-name=blat_uk_wcsf
#SBATCH --output=slurm_out/blat_uk_wcsf_%A-%a.out
#SBATCH --array=1-26
...
output_file="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/blat_array_probes/ukbb_probes/web_blat/uk_wcsf/webblat_${query_file}.out"
