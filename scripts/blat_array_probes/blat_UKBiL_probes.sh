...
#SBATCH --mem=25G
#SBATCH --output=blat_ukk_believe
#SBATCH --job-name=blat_ukk_believe
...
database_file="/dors/capra_lab/data/dna/human/hg19/hg19.2bit"
query_file="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/blat_array_probes/ukbb_probes/fa/ukbb_UKBiLEVE_probes.fa"
output_file="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/blat_array_probes/ukbb_probes/blat_output/UKBiLEVE_probes_blat.txt"
