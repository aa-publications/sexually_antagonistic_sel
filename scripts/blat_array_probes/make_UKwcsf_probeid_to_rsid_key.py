...
KEY_FILE_OUTPUT="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/blat_array_probes/ukbb_probes/UKB_WCSG.annot.key.to.bim.tsv"
...
anno_df = pd.read_csv(uk_wcsg_annot_file, sep=",", low_memory=False, usecols=keep_cols)
