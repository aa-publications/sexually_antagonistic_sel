...
my_array=(dummy 75 125)
flank_bp=${my_array[${SLURM_ARRAY_TASK_ID}]}


output_dir="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/results/2019_07_21_logistic_blat_pipeline/${flank_bp}bp"
...
ASSOC_FILE="/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/results/2019_07_21_logistic/2019_07_21_logistic.assoc.logistic.csv"
GWAS_PTHRESH=1
