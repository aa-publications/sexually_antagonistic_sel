...
OUTPUT_DIR = "/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/mega_data/merge_batches/merge_batch_without_batch4"
PLINK_FILES_TO_MERGE = os.path.join(OUTPUT_DIR, 'merge_list_without_batch4_plink_prefixes.txt')
MERGED_PLINK_FILE = os.path.join(OUTPUT_DIR, 'merged_MEGA_no_batch4_2019-04-15')
...
#     vars_miss_removed_plink_prefix, OUTPUT_DIR, merged_plink_prefix, prefix='final_maf_filtered_')
...
maf_filtered_plink_file='/dors/capra_lab/users/abraha1/prelim_studies/katja_biobank/data/mega_data/merge_batches/merge_batch_without_batch4/final_maf_filtered__merged_MEGA_no_batch4_2019-04-15'
